...
```
docker stop                           core-cadvisor-c
docker rm                             core-cadvisor-c
docker compose -p core up --build -d  cadvisor
docker compose -p core up -d          cadvisor
docker logs -f                        core-cadvisor-c
```
